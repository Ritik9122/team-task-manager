  ...
  return (
    <div className="min-h-screen bg-slate-900 px-4 py-10 text-slate-100">
      <div className="mx-auto flex max-w-5xl flex-col overflow-hidden rounded-[2rem] bg-white shadow-2xl md:flex-row">
        <div className="hidden flex-1 bg-slate-900 p-12 text-white md:block">
          <div className="space-y-6">
            <h1 className="text-4xl font-semibold">Create your account</h1>
            <p className="max-w-md text-sm text-slate-300">
              Sign up to organize teams, assign work, and keep every project moving forward.
            </p>
            <div className="space-y-4 rounded-3xl bg-white/10 p-6 text-sm text-slate-100">
              <p className="font-semibold">What you get</p>
              <p>Project boards for each team.</p>
              <p>Structured task assignment and tracking.</p>
        ...
        <div className="w-full flex-1 bg-slate-50 p-10 sm:p-12">
          ...
          <p className="mt-3 text-sm text-slate-600">Create your account and start managing team work.</p>
